...
const moviesShortTitles = movies.filter((movie) => movie.title.length < 4);
console.log(moviesShortTitles);
const moviesLongTitles = movies.filter((movie) => movie.title.length >= 30);
console.log(moviesLongTitles);
const moviesEighties = movies.filter(
  (movie) => movie.year >= 1980 && movie.year <= 1989
);
console.log(moviesEighties.length);

let tag;
const moviesWithATag = movies.map((movie) => {
  if (movie.rating >= 7) {
    tag = "Good";
...
console.log(moviesWithATag);

const moviesRatingHigherThanSix = movies
...
let goodMovies = 0;
const moviesGoodAverageBad = moviesWithATag
  .map((movie) => movie.tag)
  .reduce(function (a, b) {
    return a === "Good" ? goodMovies++ : b;
  })
  .reduce(function (a, b) {
    return a === "Average" ? averageMovies++ : b;
  })
  .reduce(function (a, b) {
    return a === "Bad" ? badMovies++ : b;
  });
console.log(moviesGoodAverageBad);
