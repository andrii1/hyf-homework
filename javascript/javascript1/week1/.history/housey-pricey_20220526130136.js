...
if (houseCostPeter > housePricePeter) { console.log("Peter is paying too much") } elseif (houseCostPeter === housePricePeter) { console.log("Peter is paying a good price")} else (houseCostPeter < housePricePeter)
