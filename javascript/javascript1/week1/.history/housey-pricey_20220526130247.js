...
if (houseCostPeter > housePricePeter) { console.log("Peter is paying too much") } elseif(houseCostPeter === housePricePeter) { console.log("Peter is paying a good price") } else { console.log("Peter is paying too little") }
if (houseCostJulia > housePriceJulia) { console.log("Julia is paying too much") } elseif (houseCostJulia === housePriceJulia) { console.log("Julia is paying a good price")} else { console.log("Julia is paying too little")}
